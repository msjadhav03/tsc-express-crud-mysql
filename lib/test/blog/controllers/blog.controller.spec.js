...
const blog_controller_1 = require("../../../src/blog/controllers/blog.controller"); // Replace "yourControllerFile" with the path to your controller file
const BlogService = __importStar(require("../../../src/blog/services/blog.services"));
describe("Controller Functions", () => {
    ...
    describe("testControllerFunction", () => {
        it("should respond with a test message", () => __awaiter(void 0, void 0, void 0, function* () {
            yield (0, blog_controller_1.testControllerFunction)(mockRequest, mockResponse);
    ...
    describe("addBlog", () => {
        it("should have been called with data", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield (0, blog_controller_1.addBlog)({ status: "started", days: 20, name: "reading" }, mockResponse);
    ...
    describe("deleteBlog", () => {
        it("should have been called with data", () => __awaiter(void 0, void 0, void 0, function* () {
            jest
                ...
                .mockResolvedValue({ statusCode: 200, message: "Success", data: [] });
            yield (0, blog_controller_1.deleteBlog)({ id: "reading" }, mockResponse);
            expect(mockResponse.send).toHaveBeenCalled();
        }));
    ...
    describe("updateBlog", () => {
        it("should have been called with data", () => __awaiter(void 0, void 0, void 0, function* () {
            jest
                ...
                .mockResolvedValue({ statusCode: 200, message: "Success", data: [] });
            yield (0, blog_controller_1.updateBlog)({ id: "reading" }, mockResponse);
            expect(mockResponse.send).toHaveBeenCalled();
        }));
    ...
    describe("fetchBlog", () => {
        it("should have been called with data", () => __awaiter(void 0, void 0, void 0, function* () {
            jest
                ...
                .mockResolvedValue({ statusCode: 200, message: "Success", data: [] });
            yield (0, blog_controller_1.fetchBlog)({ id: "reading" }, mockResponse);
            expect(mockResponse.send).toHaveBeenCalled();
        }));
        it("should have been rejected", () => __awaiter(void 0, void 0, void 0, function* () {
            jest
